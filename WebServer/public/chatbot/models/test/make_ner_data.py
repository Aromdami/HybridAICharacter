...
with open(prof_file, mode='r', encoding='utf-8-sig') as df:
    dr = csv.reader(df)
    for k, r in enumerate(dr):
...
with open(subj_file, mode='r', encoding='utf-8-sig') as df:
    dr = csv.reader(df)
    for k, r in enumerate(dr):
...
with open(classroom_file, mode='r', encoding='utf-8-sig') as df:
    dr = csv.reader(df)
    for k, r in enumerate(dr):
